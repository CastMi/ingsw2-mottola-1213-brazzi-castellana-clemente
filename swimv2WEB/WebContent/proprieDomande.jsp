					...
					<fieldset>
						<table>
							<tr>
								...
								<td style="height: 49px"><input name="titoloDomanda" type="text"
									 style="width: 185px" /></td>
							</tr>
							<tr>
								<td class="td_campi_form"><label for="descrizioneDomanda">Descrizione:</label></td>
								<td style="height: 49px"><input name="descrizioneDomanda" type="text"
									id="descrizioneDomanda" style="width: 185px" /></td>
							</tr>
							<tr>
								<% 
							...
							<tr>
								...
								<td align=center><input name="submit" type="submit" value="crea" /></td>
							</tr>
						</table>
					</fieldset>
				</form>
