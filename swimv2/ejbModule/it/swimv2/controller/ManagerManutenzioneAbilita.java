...
public class ManagerManutenzioneAbilita {
	...
	/**
	 * Controlla l'esistenza della richiesta di abilità che possiede il nome corrispondente
	 * e sia riferita all'utente che possiede quell'id
	 * @param idUtente - l'id dell'utente che ha fatto la richiesta dell'abilità
	 * @param nomeAbilita - il nome della richiesta di abilità da ricercare
	 * @return la richiesta di abilità trovata
	 * @throws EntityNotFoundException qualora la richiesta di abilità non venga trovata
	 */
	protected RichiestaAbilita getRichiestaAbilita(Utente utente, String nomeAbilita)
	 ...
	 * @param nomeAbilita - il nome dell'abilità da ricercare
	 * @return l'abilità trovata
	 * @throws EntityNotFoundException qualora l'abilità non venga trovata
	 */
	 ...
	 * @param idUtente - l'id dell'utente da ricercare
	 * @return l'utente trovato
	 * @throws EntityNotFoundException qualora l'utente non venga trovato
	 */
